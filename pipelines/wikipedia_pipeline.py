...
def get_lat_long(country, city):
    geolocator = Nominatim(user_agent='msdStadiumProject')
...
def write_wikipedia_data(**kwargs):
    ...
    data.to_csv('abfs://wikipedia-soccer-stadium-data@wikipediastadiumdata.dfs.core.windows.net/data/' + file_name,
                storage_options={
                    'account_key': 'XXXXX'
                }, index=False)